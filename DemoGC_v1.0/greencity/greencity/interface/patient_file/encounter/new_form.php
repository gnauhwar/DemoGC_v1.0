    		...
    		if($catg==12&& $stat2!='discharge')
    			{
					...
					$StringEcho.= "<tr><td style='border-top: 1px solid #000000;padding:0px;'><a onclick=\"openNewForm('" . $rootdir .'/patient_file/reportobs/patient_report_gends.php'.
                    "')\" href='JavaScript:void(0);'>" . xl_form_title($DS) . "</a></td></tr>";
