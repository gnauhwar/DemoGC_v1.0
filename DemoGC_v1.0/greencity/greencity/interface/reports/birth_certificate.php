...
?>  
<img src=" <?php echo $GLOBALS['webroot']?>/interface/pic/birth.jpg" style="margin:0px 0px" align="top"/>
...
?>
<img src=" <?php echo $GLOBALS['webroot']?>/interface/pic/birth_footer.jpg" style="margin:0px 0px" align="top"/>
